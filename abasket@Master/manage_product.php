...
<head>
	...
	<title>Abasket - Manage Products</title>
    	...
    	<div class="page-content">
			...
			<div class="content-wrapper">
                ...
                <div class="panel-heading">
						<button type="button" class="btn bg-teal-400 btn-labeled" onClick="window.location.href='add_product.php'"><b><i class="icon-add"></i></b> Add Product</button>
                ...
                <table class="table datatable-basic table-striped">
						...
						<tbody>
								...
								if($r->num_rows>0)
								{
									...
									<td>
									<select name="status" id="status" class="form-control" onChange="set_status(this.value,'product','id',<?php echo $rows['id'];?>)">
										   <option value="0" <?php if($rows['status']==0){echo "selected";}else{echo "";} ?> >Disable</option>
										   <option value="1" <?php if($rows['status']==1){echo "selected";}else{echo "";} ?>>Enable</option>
									</select>
									</td>
