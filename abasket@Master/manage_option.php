...
<head>
	...
	<title>Abasket - Manage Option</title>
	...
	<div class="page-header">
		...
		<div class="page-header-content">
			...
			<div class="page-title">
				...
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Option</span> - Manage Option</h4>
    	...
    	<div class="page-content">
			...
			<div class="content-wrapper">
                ...
                <div class="panel-heading">
                        ...
                        <button type="button" id="" onClick="global_all_delete('option','id');" class="btn btn-warning">Delete</button>
                ...
                <table class="table datatable-basic table-striped">
						...
						<tbody>
						 ...
						 include('lib/connectdb.php');
								$cat=$db->query("select * from option order by id desc");
								if($cat->num_rows>0)
								{
									$i=1; 
                                ...
                                <td><?php echo $cat_rows['option'];?></td>
								<td><a href="add_option_value.php?id=<?php echo $cat_rows['id'];?>"> Add </a></td>
								                           
                                
                                <td><a href="edit_option.php?id=<?php echo $cat_rows['id'];?>"><i class="icon-pencil7"></i> Edit</a></td>
                                <td width="15%"><a href="javascript:void(0)" onClick="global_delete('option','id',<?php echo $cat_rows['id'] ?>);"><i class="icon-cancel-circle2"></i> Delete</a></td>
